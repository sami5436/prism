...
const TOC = [
  ...
  },
  {
    ...
    label: 'Options',
    children: [
      { id: 'options-tour', label: 'Tour of the view' },
      ...
      { id: 'directional-lean', label: 'Directional Lean' },
      { id: 'iv-skew', label: 'Volatility Skew' },
      { id: 'pc-ratio', label: 'P/C Ratio' },
      { id: 'chain-views', label: 'Chain views' },
      { id: 'open-interest-levels', label: 'OI by Strike' },
      { id: 'strategies', label: 'Strategies' },
      { id: 'screener-math', label: 'Buy Candidates math' },
